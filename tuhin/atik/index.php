                        ...
                        <div class="col-lg-9 col-md-9">
                            <div class="menu-wrapper">
                                ...
                                <div class="header-btn d-none f-right d-lg-block">
                                    <a href="../admin/register.php" class="btn head-btn1">Register</a>
                                    <a href="../admin/login.php" class="btn head-btn2">Login</a>
                                </div>
                            </div>
                        </div>
                        <!-- Mobile Menu -->
                ...
                <div class="single-slider slider-height d-flex align-items-center"
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xl-8">
                                <!-- form -->
                                <form action="searchjob.php" method="POST" class="search-box">
                            ...
                            <div class="single-job-items mb-30">
                                <div class="job-items">
                                    ...
                                    <div class="job-tittle">
                                        <a href="job_details.php?status=view&&id=<?php echo $row['post_id']; ?>">
                                            <h4>
                                ...
                                <div class="items-link f-right">
                                    <a href="job_details.php?status=view&&id=<?php echo $row['post_id']; ?>">View</a>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="right-caption">
                            ...
                            <div class="support-caption">
                                ...
                                <a href="../admin/register.php" class="btn post-btn">Post a job</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
